...
<body>
   ...
   <div class="middle-container">
    <form>
        ...
        <p style="margin-left: 40px"> Your Ticket Cancellation is Successfull.</p><br>
        <a style="text-decoration: none; align-items: center; padding: 10px 75px; margin-left: 40px" class="btn" href="tripdetails">View Trip Details</a>
    </form>
    </div>
    <footer>
